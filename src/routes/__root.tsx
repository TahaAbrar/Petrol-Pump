...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A premium, modern fuel station offering quality fuel, fast service and 24/7 availability with a world-class customer experience." },
      { property: "og:site_name", content: "Total Fuel Station" },
